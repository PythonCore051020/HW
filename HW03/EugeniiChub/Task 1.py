a = "Beautiful is better than ugly. Explicit is better than implicit. Simple is better than complex." \
...
better = a.count("better")
print("Quantity words better =", better)
cis = a.count("is")
print("Quantity words is =", cis)
d = a.count('never')
print("Quantity words never =", d)
upletter = a.upper()
print (upletter)
rep = a.replace("i","&")
print(rep)
